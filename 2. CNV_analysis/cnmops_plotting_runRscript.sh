...
#SBATCH --mem=50G
#SBATCH -o /scratch/ejy4bu/err_outs/cnmops/cnmops_plotting.%A.out
#SBATCH -e /scratch/ejy4bu/err_outs/cnmops/cnmops_plotting.%A.err
#SBATCH -p standard
...
Rscript 2.\ CNV_analysis/cnmops_plotting.R